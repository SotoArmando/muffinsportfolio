    ...
    return (
        <div className="nav">
            ...
            <div className="nav_side_body col">
                ...
                <Link to='/viewport/?page=muffinsmastermind' onMouseUp={handleSidenavtoggle}><span>Web apps</span></Link>
                <Link to='/viewport/?page=muffinsmastermind' onMouseUp={handleSidenavtoggle}><span>Mobile apps</span></Link>
