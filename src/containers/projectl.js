...
export default function Projectl({ isFirst, isLast, name, pic, tags, switchWindowprojectIsOpen: handleClick }) {
    ...
    let classname = "corebox_13  row center  relative pad_l20 pad_r20   mobilepad_t24 btn hover relative btn"
    return <span className={classname} onClick={handleClick}>
        ...
        <div className="to_hover absolute col left allsize fore_9 f700 pad_l24 pad_r24 mobilepad_t24 ffam_0 f_1">

            <div className="col pad_l20 pad_r20">
                <span className="pad_l0 pad_r17 fore_9 ls_27 corebox_4 start items_center ">{name}</span>
