...
export default function Homelandingsection() {
  const hometext = [
    ['Pretty code by an ingenious person', 'f_7 f700  ffam_karla maxedcorebox_x17 corebox_9 mobilecorebox_11'],
  ...
  return (
    <div className="corebox_19 row wrap gbasis_47  " id="intro">
      <div className="center col corebox_18 mobilecorebox_15 back_2">
        <div className="maxedcorebox_x18 col center items_start">
          ...
          <div className="row space_between gbasis_43 corebox_4 mobilecorebox_5 items_end">
            ...
            <Wrappedrow gridclassName="corebox_4 items_end" basis={29} marginh={18} marginv={22} list={social_networks} item={({ _id: [text, link], marginh, marginv }) => <a className={`corebox_x1  back_blue_o0 maskicon_${text} mar_t${marginv} mar_b${marginv} mar_r${marginh} mar_l${marginh}`} href={link} target="_blank" rel="noreferrer" aria-hi />} />
