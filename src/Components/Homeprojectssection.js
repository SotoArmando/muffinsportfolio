...
export default function Homeprojectsection() {
  ...
  const squareElement = ({ marginh, marginv, _id: [text, urls] }) => (
    <div onClick={() => { setModalActive(true); setPicturesprev(text); setProjecturls(urls); }} className={`hover corebox_14 relative corebox_x14  half_horizontalmar half_verticalmar mar_t${marginv} mar_b${marginv} mar_r${marginh} mar_l${marginh}`}>
  ...
  return (
    <div className="center corebox_20 col " id="portfolio">
